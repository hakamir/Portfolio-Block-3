  ...
  <footer id="footer">
    <div class="bg-black text-white pt-8 pb-4 md:pt-16">
      <div class="container mx-auto grid grid-cols-2 gap-4">
        <div>
          <div class="pl-4">
            <h6 class="font-unbounded text-lg pb-2">Legal information</h6>
            <div>
              <ul>
        ...
        <div>
          ...
          <div class="grid grid-cols-1 md:block">
            ...
            <a class="social-link" href="https://www.spotify.com/">
              <svg class="w-8 h-8 fill-white inline" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
                <path
            ...
            <a class="social-link" href="https://www.bandcamp.com/">
              <svg class="w-8 h-8 fill-white inline" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
                <path
